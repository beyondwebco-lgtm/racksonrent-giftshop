  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <SectionHeader
          badge="POPULAR GIFT PRODUCT CATEGORIES"
          title={
            <>
              Popular <span className="text-[#B8913A]">Gift Product</span> Categories
            </>
          }
          subtitle={
            <span
        ...
        <div className="relative max-w-5xl mx-auto px-4 sm:px-12">
          ...
          {/* View All Categories Link / CTA */}
          <div className="mt-8 text-center">
            <a
              href="#opportunities"
              className="inline-flex items-center gap-2 rounded-full bg-[#FAFA33] border-2 border-[#740202] px-6 py-3 text-sm font-extrabold text-[#740202] shadow-sm hover:bg-[#740202] hover:text-[#FAFA33] transition-all hover:scale-105"
            >
