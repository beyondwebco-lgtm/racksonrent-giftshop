...
export default function Hero({ onSelectRole }: HeroProps) {
  ...
  return (
    <section className="relative pt-6 pb-10 sm:pt-10 sm:pb-14 lg:pt-16 lg:pb-20 bg-[radial-gradient(circle_at_80%_20%,rgba(107,15,26,0.08),transparent_40%),linear-gradient(180deg,#fffdf5_0%,#fff6a3_25%,#fffdf5_100%)] border-b border-[#F0E2E4] overflow-hidden" id="hero">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-8 items-center">
          ...
          <div className="lg:col-span-7 space-y-4 sm:space-y-6">
            <div>
              <span className="inline-flex items-center rounded-full bg-[#FFF6A3] px-3 py-1 sm:px-4 sm:py-1.5 text-xs sm:text-sm font-bold text-[#6B0F1A] border border-[#F0E2E4] max-w-full truncate">
                For Gift Shop Owners & Gift Entrepreneurs
              </span>
            </div>

            <h1 className="text-2xl min-[375px]:text-3xl sm:text-4xl lg:text-5xl xl:text-6xl font-extrabold tracking-tight text-[#6B0F1A] leading-[1.18] sm:leading-[1.15]">
              Give Your Products a Place{" "}
              <span className="bg-[#F4E409] text-[#3D0710] px-2 py-0.5 sm:px-3 sm:py-1 rounded-xl inline-block mt-1 border border-[#6B0F1A]/20">
              ...
              <div className="relative flex flex-col sm:flex-row items-stretch sm:items-center gap-3 sm:gap-4 z-10">
                ...
                >
                  ...
                  >
                    ...
                    <span className="text-[10px] sm:text-[11px] font-bold uppercase tracking-wider text-[#F4E409] mt-0.5 text-center">
          ...
          <div className="lg:col-span-5 relative mt-4 lg:mt-0">
            <div className="relative mx-auto max-w-md lg:max-w-none">
              <div className="animate-hero-video-entrance rounded-[1.5rem] sm:rounded-[2rem] border-2 border-[#F0E2E4] bg-[#FFFDF5] p-2.5 sm:p-3 shadow-[0_24px_70px_rgba(107,15,26,0.10)] relative overflow-hidden transition-all duration-350 hover:scale-[1.015] hover:shadow-[0_28px_80px_rgba(107,15,26,0.18)] hover:border-[#F4E409]/60 group">
                <div className="relative aspect-4/3 w-full rounded-xl sm:rounded-2xl overflow-hidden bg-[#FFF6A3]/20">
                  <video
                  ...
                  {/* Overlay Badge */}
                  <div className="absolute bottom-3 right-3 sm:bottom-6 sm:right-6 bg-[#3D0710] text-white px-3.5 py-2 sm:px-5 sm:py-2.5 rounded-full border border-sm:border-2 border-[#F4E409] shadow-xl flex items-center gap-1.5 sm:gap-2 text-[11px] sm:text-sm font-bold tracking-wide z-10">
                    <span className="w-2 h-2 sm:w-2.5 sm:h-2.5 rounded-full bg-[#F4E409] animate-ping" />
